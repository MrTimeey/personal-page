...
const contactFunction = (targetMail) => (location.href = `mailto:${targetMail}?subject=Contact%20from%20website`);
</script>
            ...
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                <div id="profile" class="w-full rounded-lg lg:rounded-l-lg hadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        <div class="block rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('../../public/profile.jpg')"></div>
                        ...
                        <div class="pt-12 pb-8">
                            <button class="button-color lg:w-full text-white font-bold py-2 px-4 rounded-full" @click="contactFunction(profile.mail)">Get In Touch</button>
                        </div>
